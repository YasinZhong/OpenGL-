...
void myobject()
{
    ...
    GLfloat l1dxyz[3]={0,3,0};
    glLightfv(GL_LIGHT1,GL_SPOT_DIRECTION,l1dxyz);
    //设置光照方向

    GLfloat l1color[3]={1,1,1};
    glLightfv(GL_LIGHT1,GL_DIFFUSE,l1color);//光线强度与颜色
    GLfloat l1ambcolor[3]={1,1,1};
    glLightfv(GL_LIGHT1,GL_AMBIENT,l1ambcolor);//环境亮度与颜色

    /*GLfloat l1speccolor[3]={1,10,1};
    glLightfv(GL_LIGHT1,GL_SPECULAR,l1color);//无效果 */
